...
const blogPosts = [
  {
    ...
    excerpt: "Learn the fundamental principles that can transform your website from ordinary to extraordinary.",
    category: "Web Design",
    content:
  ...
  },
  {
    ...
    excerpt: "Discover how color choices impact user perception and behavior in interface design.",
    category: "UI Design",
    content:
  ...
  },
  {
    ...
    excerpt: "Explore the importance of prioritizing mobile experiences in your design process.",
  ...
  },
  {
    ...
    excerpt: "Learn strategies to design landing pages that convert visitors into customers.",
    category: "Web Design",
    content:
  ...
  },
  {
    ...
    excerpt: "Master the principles of typography to enhance readability and visual appeal.",
    category: "Web Design",
    content:
  ...
  },
  {
    ...
    excerpt: "Discover techniques to improve your website's speed and performance for search engines.",
    category: "SEO",
    content:
          ...
          >
            <div className="p-4 border-b border-gray-100">
              <p className="text-sm text-gray-500">
                Found <span className="font-medium text-gray-900">{searchResults.length}</span> results for "
