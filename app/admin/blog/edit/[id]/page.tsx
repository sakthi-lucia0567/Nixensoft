...
export default function EditBlogPage() {
  ...
  const { blogs, updateBlog, categories, tags, addCategory, addTag } = useBlogStore()
  ...
  const handleAddCategory = () => {
    if (newCategory.trim()) {
      ...
      setSelectedCategories([...selectedCateg  {
      const categoryId = addCategory(newCategory.trim())
            ...
            <div className="space-y-4">
              ...
              {status === "scheduled" && (
                <div>
                  ...
                  />
                  {errors.scheduledFor && (
                    <p className="mt-1 text-sm text-red-500">{errors.scheduledFor}</p>
                  )}
                </div>
              )}
            </div>
