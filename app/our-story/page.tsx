...
export default function OurStoryPage() {
  return (
    <>
      <Seo
        pageName="Our Story | Nixensoft - Digital Marketing Agency"
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                Founded in 2015, Nixensoft began as a small team of digital
                enthusiasts with a shared vision: to help businesses in
                Coimbatore harness the power of digital marketing to grow and
                succeed.
              </p>
              <p className="text-lg text-gray-700 mb-6">
                {` What started as a three-person operation has now grown into a
                full-service digital marketing agency with a team of over 30
                specialists across SEO, content marketing, social media, web
                development, and more.`}
              </p>
              <p className="text-lg text-gray-700">
                {`Throughout our journey, our commitment to delivering measurable
                results and exceptional service has remained unwavering. We've
                helped hundreds of businesses, from local startups to
                established enterprises, achieve their digital marketing goals.`}
              </p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-700">
              {`At Nixensoft, we're driven by a clear mission and guided by strong
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-lg text-gray-700 mb-6">
                ...
                solutions that drive growth, enhance online presence, and
                deliver measurable results.
              </p>
              <p className="text-lg text-gray-700">
                {`We strive to be more than just a service provider – we aim to be
                a trusted partner in our clients' success, helping them navigate
                the ever-evolving digital landscape with confidence.`}
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-lg text-gray-700 mb-6">
                To be the most trusted digital marketing agency in South India,
                known for our expertise, innovation, and commitment to client
                success.
              </p>
              <p className="text-lg text-gray-700">
                We envision a future where every business, regardless of size,
                can harness the power of digital marketing to reach its full
                potential and thrive in an increasingly connected world.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-700">
                ...
                improving our skills and services to deliver the best results.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-700">
                We embrace change and continuously explore new ideas and
                technologies to stay ahead in the digital landscape.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-3">
                Best Digital Marketing Agency 2022
              </h3>
              <p className="text-gray-700">
                Awarded by the Coimbatore Business Association for excellence in
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
                Recognized as a Google Partner agency for our expertise in
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-3">
                Top 10 SEO Companies in South India
              </h3>
              <p className="text-gray-700">
                Listed among the top 10 SEO companies in South India by Digital
